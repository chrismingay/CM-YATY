...
class bb_entity_Entity : Object{
	...
	public virtual bool m_IsOnScreen(){
		return bb_functions.bb_functions_RectOverRect(f_X,f_Y,f_W,f_H,(float)(bb__LDApp.g_ScreenX-50),(float)(bb__LDApp.g_ScreenY-50),(float)(bb__LDApp.g_ScreenWidth+100),(float)(bb__LDApp.g_ScreenHeight+100));
	}
